        ...
        <section class="section-about block">
          ...
          <div class="about-us__content">
            <div class="about-us__text">
              Mình đang là một Front End Developer, tiktoker, và mentor dạy lập
              trình Front-End. Mình may mắn làm việc với những công ty tuyệt vời
              và mình cũng đã từng giảng viên tại 1 trung tâm IT tại Đà Nẵng.
              Trong nhiều năm làm việc, sau ra trường mình đã làn sóng IT đánh
              cho bầm dập, những lần vấp gã mà không ai định hướng. Mình có 1
              kênh tiktok nơi mà mình chia sẻ lại những kiến thức hay mà mình đã
              trải qua. kênh tiktok <span class="text-purple">DEVFE68</span> của
              mình. Nội dung trên tiktok đa dạng chủ đề từ Web Dev, cuộc sống...
              được đưa ra từ những kiến thức thực tế, những gì mình đã từng trải
              qua.
            </div>
            <div class="img-tiktok">
              <img src={myTiktokImg} alt="kenh tiktok cua toi" />
            </div>
          </div>
        </section>
        <section class="section-why block">
          ...
          <div className="why-wrapper">
            <div className="img-wrapper">
              <img src={userImg} alt="user coding" />
            </div>
            <div class="why__text">
              <h6 class="text-purple">TÔI LÀ MỘT DEVELOPER TRÁI NGÀNH !</h6>
              <h6>
                ...
                đề ở đây là đọc cái gì, đi theo hướng nào, đi thế nào để nhanh
                hơn, để cạnh tranh với các bạn cùng trang lứa hay có thể các bạn
          ...
          <div class="card-list">
            <div class="card text-white">
              <div class="card-img-block">
                <img src={CourseReactImg} alt="" class="card-img" />
              </div>
